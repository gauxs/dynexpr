...
func TestAttributeCondition(t *testing.T) {
	...
	if err != nil {
		...
		var expectedValuesMap = map[string]types.AttributeValue{
			":0": &types.AttributeValueMemberS{
				Value: "NamePrefix",
			},
			":1": &types.AttributeValueMemberS{
				Value: "SomeBankAccntNumber",
			},
			":2": &types.AttributeValueMemberS{
				Value: "ChildrenName",
			},
			":3": &types.AttributeValueMemberS{
				Value: "PartionValue",
			},
			":4": &types.AttributeValueMemberS{
				Value: "SortKeyPrefix",
			},
		}
		...
		var expectedValuesMap = map[string]types.AttributeValue{
			...
			":2": &types.AttributeValueMemberM{
				Value: map[string]types.AttributeValue{
					"account_type": &types.AttributeValueMemberN{
						Value: strconv.Itoa(int(SAVINGS)),
					},
					"bank_account_number": &types.AttributeValueMemberN{
						Value: "4857372829",
					},
				},
			},
			":3": &types.AttributeValueMemberM{
				Value: map[string]types.AttributeValue{
					"name": &types.AttributeValueMemberS{
						Value: "NewChild",
					},
					"dob": &types.AttributeValueMemberS{
						Value: "2023-05-03T00:00:00Z",
					},
				},
			},
			":4": &types.AttributeValueMemberL{
