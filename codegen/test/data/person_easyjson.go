...
func easyjsonDb0593a3DecodeDynexprCodegenTestData4(in *jlexer.Lexer, out *BankAccount) {
	...
	for !in.IsDelim('}') {
		...
		case "OutsidePkg":
			easyjsonDb0593a3DecodeNet(in, &out.OutsidePkg)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjsonDb0593a3EncodeDynexprCodegenTestData4(out *jwriter.Writer, in BankAccount) {
	...
	}
	{
		...
		easyjsonDb0593a3EncodeNet(out, in.OutsidePkg)
	}
	out.RawByte('}')
}
...
func easyjsonDb0593a3DecodeNet(in *jlexer.Lexer, out *net.AddrError) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDb0593a3EncodeNet(out *jwriter.Writer, in net.AddrError) {
	out.RawByte('{')
	first := true
	_ = first
	{
