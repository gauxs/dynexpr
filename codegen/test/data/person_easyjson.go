...
func easyjsonDb0593a3DecodeDynexprCodegenTestData4(in *jlexer.Lexer, out *BankAccount) {
	...
	for !in.IsDelim('}') {
		...
		case "OutsidePkg":
			easyjsonDb0593a3DecodeDatabaseSql(in, &out.OutsidePkg)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjsonDb0593a3EncodeDynexprCodegenTestData4(out *jwriter.Writer, in BankAccount) {
	...
	{
		const prefix string = ",\"OutsidePkg\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		easyjsonDb0593a3EncodeDatabaseSql(out, in.OutsidePkg)
	}
	out.RawByte('}')
}
...
func easyjsonDb0593a3DecodeDatabaseSql(in *jlexer.Lexer, out *sql.DBStats) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDb0593a3EncodeDatabaseSql(out *jwriter.Writer, in sql.DBStats) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	{
		const prefix string = ",\"OpenConnections\":"
		out.RawString(prefix)
		out.Int(int(in.OpenConnections))
	}
	{
		const prefix string = ",\"InUse\":"
		out.RawString(prefix)
