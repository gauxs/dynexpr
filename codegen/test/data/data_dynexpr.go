// Code generated by dynexpr for marshaling/unmarshaling. DO NOT EDIT.
...
type BankAccount_ExpressionBuilder struct {
	OutsidePkg dynexpr.DynamoAttribute[net.AddrError]
}
...
func (o *BankAccount_ExpressionBuilder) BuildTree(name string) *dynexpr.DynamoAttribute[*BankAccount_ExpressionBuilder] {
	...
	o.OutsidePkg = *dynexpr.NewDynamoAttribute[net.AddrError]().WithName("add_err")
